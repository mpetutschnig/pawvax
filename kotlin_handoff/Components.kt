    ...
    PawCard {
        Row(
            ...
            Box(
                ...
                Icon(
                    imageVector = Icons.Outlined.Vaccines, // or Syringe from extended
                    contentDescription = null,
                    tint = iconTint,
...
fun PawBottomNavigation(
    ...
    val items = listOf(
        NavItem("animals",   "Animals",  Icons.Outlined.Pets),
        NavItem("alerts",    "Alerts",   Icons.Outlined.Notifications),
        NavItem("scan",      "Scan",     Icons.Outlined.QrCodeScanner),
        NavItem("documents", "Docs",     Icons.Outlined.Description),
